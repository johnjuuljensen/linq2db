...
namespace LinqToDB.Scaffold
{
	...
	public sealed class CodeGenerationOptions
	{
		...
		/// <list type="bullet">
		/// <item>Default: <see langword="true" /></item>
		/// <item>In T4 compability mode: <see langword="true" /> (both CS1573 and CS1591, T4 supporessed only CS1591)</item>
		/// </list>
		/// </summary>
		...
		/// </list>
		/// </summary>
		public ISet<string> ConflictingNames { get; } = new HashSet<string>(StringComparer.Ordinal);
		...
		/// When <see langword="null"/>, default linq2db header text will be used.
		/// </summary>
