...
namespace LinqToDB.CommandLine
{
	partial class ScaffoldCommand : CliCommand
	{
		...
		private static void ProcessCodeGenOptions(Dictionary<CliOption, object?> options, CodeGenerationOptions settings)
		{
			...
			// entity layout
			if (options.Remove(CodeGen.EntityLayout, out value))
			{
				var str = (string)value!;
				settings.EntityLayout = str switch
				{
					"table"        => LinqToDB.Scaffold.EntityLayout.Table,
					"list"         => LinqToDB.Scaffold.EntityLayout.List,
					"list-compact" => LinqToDB.Scaffold.EntityLayout.ListCompact,
					"list-dense"   => LinqToDB.Scaffold.EntityLayout.ListDense,
					_              => throw new InvalidOperationException($"Unsuppored value for option {CodeGen.EntityLayout.Name}: {str}"),
				};
			}
